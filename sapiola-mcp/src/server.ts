...
import { GraphServiceClient } from "./generated/sapiola/v1/graph.client";
import { loadSapiolaConfig } from "./config";
...
const graphClient = new GraphServiceClient(transport);
